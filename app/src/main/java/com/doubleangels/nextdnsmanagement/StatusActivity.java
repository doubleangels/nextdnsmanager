...
public class StatusActivity extends AppCompatActivity {
    ...
    /**
     * Called when the activity is starting. Initializes Sentry and sets up the
    ...
    /**
     * Called when the activity is about to be destroyed. Releases the SentryManager
     * instance.
     */
    @Override
    ...
    protected void attachBaseContext(Context newBase) {
        ...
        // Determine the new locale from the configuration or default if no locales are
        // set
