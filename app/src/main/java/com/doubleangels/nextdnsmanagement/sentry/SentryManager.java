...
public class SentryManager {
    ...
    /**
     * Captures an exception with Sentry. If Sentry is disabled (based on user preference),
     * logs the exception using Android's Log.e() but does not send it to Sentry.
     *
